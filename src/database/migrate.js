...
const migrations = [
  ...
  `CREATE TABLE IF NOT EXISTS members (
    ...
    ares_races_trained INTEGER DEFAULT 0,
    skywarn_trained INTEGER DEFAULT 0,
    incident_command_trained INTEGER DEFAULT 0,
    cpr_first_aid_certified INTEGER DEFAULT 0,
